...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private final String help_text = "ExpressionRecognition is as much a developer tool as it is a conceptual proof of technology showcasing Luxand FaceSDK";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (res != FSDK.FSDKE_OK) {
            ...
            FSDK.SetTrackerMultipleParameters(mDraw.mTracker, "DetectGender=false;DetectExpression=true", errpos);
            if (errpos[0] != 0) {
