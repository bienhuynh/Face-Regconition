    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        While Not needClose
            ...
            For i = 0 To IDs.Length - 1
                ...
                AttributeValues = ""
                If 0 = FSDK.GetTrackerFacialAttribute(tracker, 0, IDs(i), "Expression", AttributeValues, 1024) Then
                    Dim ConfidenceSmile As Single
                    Dim ConfidenceEyesOpen As Single
                    FSDK.GetValueConfidence(AttributeValues, "Smile", ConfidenceSmile)
                    FSDK.GetValueConfidence(AttributeValues, "EyesOpen", ConfidenceEyesOpen)

                    Dim str As String
                    str = "Smile: " + CInt(ConfidenceSmile * 100).ToString + "%; Eyes open: " + CInt(ConfidenceEyesOpen * 100).ToString + "%"
