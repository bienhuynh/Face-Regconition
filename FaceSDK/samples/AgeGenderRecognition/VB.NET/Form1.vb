...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If (FSDK.ActivateLibrary("fhPKopJVjHpnsV6/aumzjOvApHU7gnFduuovOu1DRngQEEevUnlpLfSAhNIhLVjzPYYbhmrz36x9Xnn1AZ/8HOcgXtIaZxOxZzNXNwS3ezLiwFwZGhY9w3S+beKvuIC8DhosdzRYCSGx4H9hC1A+jAHqTPjBTr42nKiOZ+y3H70=") <> FSDK.FSDKE_OK) Then
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        While Not needClose
            ...
            For i = 0 To IDs.Length - 1
                ...
                AttributeValues = ""
                Dim AttributeValuesAge As String
                AttributeValuesAge = ""
                If 0 = FSDK.GetTrackerFacialAttribute(tracker, 0, IDs(i), "Gender", AttributeValues, 1024) _
                    And 0 = FSDK.GetTrackerFacialAttribute(tracker, 0, IDs(i), "Age", AttributeValuesAge, 1024) Then
                    Dim str As String
                    Dim ConfidenceAge As Single
                    FSDK.GetValueConfidence(AttributeValuesAge, "Age", ConfidenceAge)
                    str = "Age: " + CInt(ConfidenceAge).ToString + ", "
                    ...
                    If ConfidenceMale > ConfidenceFemale Then
                        str = str + "Male, " + CInt(ConfidenceMale * 100).ToString + "%"
                    Else : str = str + "Female, " + CInt(ConfidenceFemale * 100).ToString + "%"
                    End If
