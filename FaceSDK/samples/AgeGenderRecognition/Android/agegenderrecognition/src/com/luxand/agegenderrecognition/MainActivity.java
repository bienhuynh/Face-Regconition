...
import com.luxand.agegenderrecognition.R;
...
public class MainActivity extends Activity implements OnClickListener {
    ...
    private final String help_text = "AgeGenderRecognition is as much a developer tool as it is a conceptual proof of technology showcasing Luxand FaceSDK";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int res = FSDK.ActivateLibrary("fhPKopJVjHpnsV6/aumzjOvApHU7gnFduuovOu1DRngQEEevUnlpLfSAhNIhLVjzPYYbhmrz36x9Xnn1AZ/8HOcgXtIaZxOxZzNXNwS3ezLiwFwZGhY9w3S+beKvuIC8DhosdzRYCSGx4H9hC1A+jAHqTPjBTr42nKiOZ+y3H70=");
        if (res != FSDK.FSDKE_OK) {
            ...
            FSDK.SetTrackerMultipleParameters(mDraw.mTracker, "DetectAge=true;DetectGender=true;DetectExpression=false", errpos);
            if (errpos[0] != 0) {
...
class ProcessImageAndDrawResults extends View {
    ...
    public ProcessImageAndDrawResults(Context context) {
        ...
        mPaintBlue.setTextSize(14 * MainActivity.sDensity);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        */
        ...
        for (int i = 0; i < (int) face_count[0]; ++i) {
            ...
            mAttributeValues[i] = String.format("Age: %d, %s:%d%%", (int)confidenceAge[0], (confidenceMalePercent>confidenceFemalePercent)?"Male":"Female", Math.max(confidenceMalePercent, confidenceFemalePercent));
        }
        ...
        for (int i = 0; i < face_count[0]; ++i) {
            ...
            canvas.drawText(mAttributeValues[i], mRectangle.left + 0.5f*(mRectangle.right - mRectangle.left), mRectangle.top + 0.1f*(mRectangle.bottom - mRectangle.top), mPaintBlue);
